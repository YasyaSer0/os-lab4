...
CLI (Command Line Interface) — це текстовий інтерфейс взаємодії з операційною системою за допомогою команд.
...
- Ctrl + C - примусове завершення виконання команди (надсилає сигнал INT).
- Ctrl + D - завершення сеансу або передача сигналу EOF.
- Ctrl + Z - призупинення процесу та переведення його у стан Stopped.
